...
const loginThird = (type: number) =>{
  switch (type) {
    ...
    case 2:
      ...
      const insUrl = 'https://api.instagram.com/oauth/authorize?client_id=1259749124876910&redirect_uri=https://swapiflyapi.honglanshuzi.com/index.php/index/index/ins_login&scope=user_profile,user_media&response_type=code'
